        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-black text-white tracking-tighter uppercase italic flex items-center gap-2">
                PDF <span className="text-[#CCFF00]">Mode Shift</span>
              </h1>
              <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-mono">In-browser local PDF color remapper</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              <span className="hidden sm:inline">Engine Details</span>
            </button>
              ...
              <div className="bg-[#111111] rounded-2xl border border-white/10 p-6 shadow-xl grid grid-cols-1 md:grid-cols-2 gap-6 font-mono">
                <div>
                  ...
                  <p className="text-[11px] text-zinc-400 leading-relaxed uppercase tracking-wide">
                    Instead of raw RGB negation which destroys graphics and charts, our algorithm computes Hue and Lightness. Neutrals are re-mapped to custom profiles while colors remain fully legible.
                  </p>
                </div>
                <div>
                  <h3 className="font-black text-white text-xs uppercase tracking-wider mb-2.5 flex items-center gap-2 text-[#CCFF00]">
                  ...
                  <p className="text-[11px] text-zinc-400 leading-relaxed uppercase tracking-wide">
                    Your confidential documents are loaded as vector streams locally. No internet transmission occurs. Color compilation is processed 100% on your device's CPU.
                  </p>
                </div>
              </div>
            </motion.div>
                      ...
                      {pageRangeMode === 'custom' && (
                        ...
                        >
                          ...
                          <span className="text-[9px] font-mono uppercase tracking-tight text-zinc-500 block mt-1.5 px-0.5">
                            Use commas for single pages, dashes for ranges.
                          </span>
                        </motion.div>
                      )}
                    </div>
