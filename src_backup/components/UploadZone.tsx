  ...
  return (
    <div className="flex flex-col items-center justify-center max-w-2xl w-full mx-auto p-4">
      ...
      >
        ...
        <span>100% Client-Side & Confidential</span>
      </motion.div>
        ...
        <div className="flex flex-col items-center justify-center space-y-8 relative z-10">
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs text-zinc-400 max-w-sm mx-auto font-mono uppercase tracking-widest leading-relaxed">
              Drop file here or click below to search your local filesystem
            </p>
          </div>
      ...
      >
        <div className="flex items-start gap-4 p-5 bg-[#111] rounded-2xl border border-white/5 shadow-md">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-white">100% Secure</h4>
            <p className="text-[11px] text-zinc-500 mt-1 leading-relaxed">Files never leave your system. All remapping is compiled local to your CPU.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 p-5 bg-[#111] rounded-2xl border border-white/5 shadow-md">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-white">Crisp Vectors</h4>
            <p className="text-[11px] text-zinc-500 mt-1 leading-relaxed">Adjustable scaling bounds up to 4.0x scale (300+ DPI) for sharp reading canvases.</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 p-5 bg-[#111] rounded-2xl border border-white/5 shadow-md">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-white">Smart Mapping</h4>
            <p className="text-[11px] text-zinc-500 mt-1 leading-relaxed">Smart mode preserves logo icons and charts while gently darkening margins.</p>
          </div>
        </div>
      </motion.div>
    </div>
