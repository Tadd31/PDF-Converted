  ...
  return (
    <div className="space-y-5 bg-[#161616] p-5 rounded-xl border border-white/5 shadow-md">
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider">
          <span className="text-zinc-400 flex items-center gap-1.5">
            <Sun size={13} className="text-zinc-400" /> Brightness
          </span>
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider">
          <span className="text-zinc-400 flex items-center gap-1.5">
            <Eye size={13} className="text-zinc-400" /> Contrast
          </span>
      ...
      <div className="space-y-2">
        <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider">
          <span className="text-zinc-400 flex items-center gap-1.5">
            <RotateCw size={13} className="text-zinc-400" /> Hue Rotate
          </span>
      ...
      {config.mode !== 'grayscale' && config.mode !== 'contrast_bw' && (
        <div className="flex items-center justify-between pt-3 border-t border-white/10">
          <label htmlFor="grayscale-toggle" className="text-[10px] font-bold uppercase tracking-wider text-zinc-400 cursor-pointer">
            Grayscale (Pre-Filter)
          </label>
